...
// | 3. Share it in a public repository so others can use               |
// |    the library too.                                                |
// |                                                                    |
...
for (var key in b2ShapeDef.prototype) {
	var obj = b2ShapeDef.prototype[key];
	b2BoxDef.prototype[key] = obj;
}
...
b2CircleShape.prototype = b2Shape.prototype;
b2CircleShape_prototypeadd = {
	TestPoint: function(p) {
...
for (var key in b2CircleShape_prototypeadd) {
	var obj = b2CircleShape_prototypeadd[key];
	b2CircleShape.prototype[key] = obj;
}
...
for (var key in b2ShapeDef.prototype) {
	var obj = b2ShapeDef.prototype[key];
	b2PolyDef.prototype[key] = obj;
}
b2PolyDef_prototypeadd = {

	vertices: new Array(b2Settings.b2_maxPolyVertices),
	vertexCount: 0
};
for (var key in b2PolyDef_prototypeadd) {
	var obj = b2PolyDef_prototypeadd[key];
	b2PolyDef.prototype[key] = obj;
}
...
for (var key in b2Shape.prototype) {
	var obj = b2Shape.prototype[key];
	b2PolyShape.prototype[key] = obj;
}
b2PolyShape_prototypeadd = {
	TestPoint: function(p) {
...
for (var key in b2PolyShape_prototypeadd) {
	var obj = b2PolyShape_prototypeadd[key];
	b2PolyShape.prototype[key] = obj;
}
...
// ┌────────────────────────────────────────────────────────────────────┐
// | b2ContactConstraintPoint class                                     |
// └────────────────────────────────────────────────────────────────────┘
...
for (var key in b2Contact.prototype) {
	var obj = b2Contact.prototype[key];
	b2CircleContact.prototype[key] = obj;
}
b2CircleContact_prototypeadd = {
...
for (var key in b2CircleContact_prototypeadd) {
	var obj = b2CircleContact_prototypeadd[key];
	b2CircleContact.prototype[key] = obj;
}
...
for (var key in b2Contact.prototype) {
	var obj = b2Contact.prototype[key];
	b2NullContact.prototype[key] = obj;
}
b2NullContact_prototypeadd = {
	Evaluate: function() {},
	GetManifolds: function() {
		return null;
	}
};
for (var key in b2NullContact_prototypeadd) {
	var obj = b2NullContact_prototypeadd[key];
	b2NullContact.prototype[key] = obj;
}

// ┌────────────────────────────────────────────────────────────────────┐
// | b2PolyAndCircleContact class                                       |
// └────────────────────────────────────────────────────────────────────┘
...
for (var key in b2Contact.prototype) {
	var obj = b2Contact.prototype[key];
	b2PolyAndCircleContact.prototype[key] = obj;
}
b2PolyAndCircleContact_prototypeadd = {
...
for (var key in b2PolyAndCircleContact_prototypeadd) {
	var obj = b2PolyAndCircleContact_prototypeadd[key];
	b2PolyAndCircleContact.prototype[key] = obj;
}
...
for (var key in b2Contact.prototype) {
	var obj = b2Contact.prototype[key];
	b2PolyContact.prototype[key] = obj;
}
b2PolyContact_prototypeadd = {
...
for (var key in b2PolyContact_prototypeadd) {
	var obj = b2PolyContact_prototypeadd[key];
	b2PolyContact.prototype[key] = obj;
}
...
for (var key in b2PairCallback.prototype) {
	var obj = b2PairCallback.prototype[key];
	b2ContactManager.prototype[key] = obj;
}
b2ContactManager_prototypeadd = {
...
for (var key in b2ContactManager_prototypeadd) {
	var obj = b2ContactManager_prototypeadd[key];
	b2ContactManager.prototype[key] = obj;
}
...
for (var key in b2Joint.prototype) {
	var obj = b2Joint.prototype[key];
	b2DistanceJoint.prototype[key] = obj;
}
b2DistanceJoint_prototypeadd = {
	//--------------- Internals Below -------------------
	PrepareVelocitySolver: function() {
		var tMat;
...
for (var key in b2DistanceJoint_prototypeadd) {
	var obj = b2DistanceJoint_prototypeadd[key];
	b2DistanceJoint.prototype[key] = obj;
}
...
for (var key in b2JointDef.prototype) {
	var obj = b2JointDef.prototype[key];
	b2DistanceJointDef.prototype[key] = obj;
}
b2DistanceJointDef_prototypeadd = {

	anchorPoint1: new b2Vec2(),
	anchorPoint2: new b2Vec2()
};
for (var key in b2DistanceJointDef_prototypeadd) {
	var obj = b2DistanceJointDef_prototypeadd[key];
	b2DistanceJointDef.prototype[key] = obj;
}
...
for (var key in b2Joint.prototype) {
	var obj = b2Joint.prototype[key];
	b2GearJoint.prototype[key] = obj;
}
b2GearJoint_prototypeadd = {
	GetAnchor1: function() {
...
for (var key in b2GearJoint_prototypeadd) {
	var obj = b2GearJoint_prototypeadd[key];
	b2GearJoint.prototype[key] = obj;
}
...
for (var key in b2JointDef.prototype) {
	var obj = b2JointDef.prototype[key];
	b2GearJointDef.prototype[key] = obj;
}
b2GearJointDef_prototypeadd = {

	joint1: null,
	joint2: null,
	ratio: null
};
for (var key in b2GearJointDef_prototypeadd) {
	var obj = b2GearJointDef_prototypeadd[key];
	b2GearJointDef.prototype[key] = obj;
}
...
for (var key in b2Joint.prototype) {
	var obj = b2Joint.prototype[key];
	b2MouseJoint.prototype[key] = obj;
}
b2MouseJoint_prototypeadd = {
	GetAnchor1: function() {
...
for (var key in b2MouseJoint_prototypeadd) {
	var obj = b2MouseJoint_prototypeadd[key];
	b2MouseJoint.prototype[key] = obj;
}
...
for (var key in b2JointDef.prototype) {
	var obj = b2JointDef.prototype[key];
	b2MouseJointDef.prototype[key] = obj;
}
b2MouseJointDef_prototypeadd = {
...
for (var key in b2MouseJointDef_prototypeadd) {
	var obj = b2MouseJointDef_prototypeadd[key];
	b2MouseJointDef.prototype[key] = obj;
}
...
for (var key in b2Joint.prototype) {
	var obj = b2Joint.prototype[key];
	b2PrismaticJoint.prototype[key] = obj;
}
b2PrismaticJoint_prototypeadd = {
...
for (var key in b2PrismaticJoint_prototypeadd) {
	var obj = b2PrismaticJoint_prototypeadd[key];
	b2PrismaticJoint.prototype[key] = obj;
}
...
b2PrismaticJointDef_prototypeadd = {
...
for (var key in b2PrismaticJointDef_prototypeadd) {
	var obj = b2PrismaticJointDef_prototypeadd[key];
	b2PrismaticJointDef.prototype[key] = obj;
}
...
for (var key in b2Joint.prototype) {
	var obj = b2Joint.prototype[key];
	b2PulleyJoint.prototype[key] = obj;
}
b2PulleyJoint_prototypeadd = {
	GetAnchor1: function() {
...
for (var key in b2PulleyJoint_prototypeadd) {
	var obj = b2PulleyJoint_prototypeadd[key];
	b2PulleyJoint.prototype[key] = obj;
}
...
for (var key in b2JointDef.prototype) {
	var obj = b2JointDef.prototype[key];
	b2PulleyJointDef.prototype[key] = obj;
}
b2PulleyJointDef_prototypeadd = {
...
for (var key in b2PulleyJointDef_prototypeadd) {
	var obj = b2PulleyJointDef_prototypeadd[key];
	b2PulleyJointDef.prototype[key] = obj;
}
...
for (var key in b2Joint.prototype) {
	var obj = b2Joint.prototype[key];
	b2RevoluteJoint.prototype[key] = obj;
}
b2RevoluteJoint_prototypeadd = {
	GetAnchor1: function() {
		var tMat = this.m_body1.m_R;
		return new b2Vec2(this.m_body1.m_position.x + (tMat.col1.x * this.m_localAnchor1.x + tMat.col2.x * this.m_localAnchor1.y),
			this.m_body1.m_position.y + (tMat.col1.y * this.m_localAnchor1.x + tMat.col2.y * this.m_localAnchor1.y));
...
for (var key in b2RevoluteJoint_prototypeadd) {
	var obj = b2RevoluteJoint_prototypeadd[key];
	b2RevoluteJoint.prototype[key] = obj;
}
...
for (var key in b2JointDef.prototype) {
	var obj = b2JointDef.prototype[key];
	b2RevoluteJointDef.prototype[key] = obj;
}
b2RevoluteJointDef_prototypeadd = {
	anchorPoint: null,
	lowerAngle: null,
	upperAngle: null,
	motorTorque: null,
...
for (var key in b2RevoluteJointDef_prototypeadd) {
	var obj = b2RevoluteJointDef_prototypeadd[key];
	b2RevoluteJointDef.prototype[key] = obj;
}